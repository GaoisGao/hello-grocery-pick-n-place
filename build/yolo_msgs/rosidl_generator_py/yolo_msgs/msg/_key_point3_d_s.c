...
bool yolo_msgs__msg__key_point3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolo_msgs.msg._key_point3_d", (char *)PyUnicode_1BYTE_DATA(module_attr), 27) == 0);
    assert(strncmp("KeyPoint3D", (char *)PyUnicode_1BYTE_DATA(name_attr), 10) == 0);
